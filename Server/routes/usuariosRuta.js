...
router.get('/usuarios/usuarioid:usuarioid', usuariosController.getUsuarioByusuarioid);
router.delete('/usuarios/usuarioid/:usuarioid', usuariosController.delete);
router.post('/usuarios', usuariosController.insert); 
router.put('/usuarios/usuarioid/:usuarioid', usuariosController.update);
